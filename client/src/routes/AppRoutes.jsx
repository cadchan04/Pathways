...
import SuggestedTrainRoutes from "../components/Route/TrainRoutes/SuggestedTrainRoutes.jsx";
...
export default function AppRoutes() {
  return (
    <Routes>
      ...
      <Route path="/train-routes" element={<ProtectedRoute><SuggestedTrainRoutes /></ProtectedRoute>} />
